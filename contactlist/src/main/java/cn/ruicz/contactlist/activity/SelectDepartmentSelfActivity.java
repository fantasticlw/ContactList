...
import cn.ruicz.contactlist.holder.SelectDepartSelfHolder;
 ...
 * Remark -------------选择部门  上下各级独立-------------
 */
public class SelectDepartmentSelfActivity extends BaseActivity implements
    ...
    public void getContactsByAuxiliaryPolice() {
        ...
        waitDialog.show();
        HttpManager.getInstance().getPoliceDeptAndUsers(this, requestUrl, new Consumer<String>() {
            @Override
...
//                                .setViewHolder(new SelectDepartSelfHolder(this))
//                                .setContent(true);
//                    }
//                    else {
//                        newNode = new TreeNode(new PersonTreeItem(table))
...
//                }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if(!mIsSingleSelect) {
            ...
            setResult(ContactConst.iGetDeaprtSelf, intent);
            finish();
            return true;
        }
