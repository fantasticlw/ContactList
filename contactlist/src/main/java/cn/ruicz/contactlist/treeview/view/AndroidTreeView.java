package cn.ruicz.contactlist.treeview.view;
...
import cn.ruicz.contactlist.treeview.holder.SimpleViewHolder;
...
public class AndroidTreeView {
    ...
    private TreeNode.TreeNodeSelectedListener mSelectedListener;
    ...
    public void setSelectedListener(TreeNode.TreeNodeSelectedListener selectedListener) {
    ...
    private void checkSelected(TreeNode treeNode){
        if(treeNode != null){
            ...
            checkSelected(treeNode.getParent());
