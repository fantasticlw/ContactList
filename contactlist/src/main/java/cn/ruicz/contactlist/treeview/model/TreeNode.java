package cn.ruicz.contactlist.treeview.model;
...
import cn.ruicz.contactlist.treeview.view.TreeNodeWrapperView;
...
public class TreeNode {
    ...
    private boolean mExpanded; //是否展开
    private boolean mIsContent; //是否是内容
    ...
    public TreeNode setContent(boolean content){
        mIsContent = content;
        return this;
    }
    ...
    public interface TreeNodeSelectedListener{
        ...
        //void onSelected(List<TreeNode> treeNodes);
    }
