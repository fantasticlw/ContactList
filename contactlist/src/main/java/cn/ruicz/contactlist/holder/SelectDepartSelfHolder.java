...
public class SelectDepartSelfHolder extends TreeNode.BaseNodeViewHolder<PersonTreeItem> {
    ...
    public SelectDepartSelfHolder(Context context) {
        super(context);
        ...
        mCbCheck.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (buttonView.isPressed()) {
                    getTreeView().selectNodeSelf(node, isChecked);
